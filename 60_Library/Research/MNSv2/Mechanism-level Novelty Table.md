...
|**Method / Lineage**|**Domain**|**Obj-Slot**|**Episodic Bank**|**Write Control (Freeze/Decay)**|**Explicit Reactivation + Assignment**|**Event-centric Eval**|**Long-context Efficient Temporal**|
|---|---|---|---|---|---|---|---|
...
|**PermaTrack (Obj Permanence)**|MOT/Tracking|✓|✗|✗/△ (learned recurrence)|△ (tracking continuity)|△ (occlusion 관점은 있음)|✗|
...
**표에서 네 방법(Ours)의 타겟 포지션은 아래처럼 “빈칸을 채우는 조합”으로 고정됨.**
...
원하면, 이 표를 “WACV 카메라레디 스타일”로 더 공격적으로 다듬어서

- (a) 비교 대상 6~8개로 압축,
    
- (b) 각 셀에 체크/부분체크 기준을 각주로 정의,
    
- (c) 너의 주장과 직접 연결되는 열(Write-control / Event-eval / Reactivation)을 강조
